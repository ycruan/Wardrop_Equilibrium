...
function getObj() {
	var paths = [
		...
		{
			desc: 'E Foothill Blvd and Huntington Dr',
			len: 7763,
			pts: [
				{lat:34.148744, lng:-117.9921699},
				{lat:34.1514583, lng:-117.9921597},
		...
		},
		{
			...
			pts: [
				...
				{lat:34.1470599, lng:-117.994964},
				{lat:34.1358758, lng:-117.9950504},
				{lat:34.1358919, lng:-117.9984997},
				{lat:34.1404254, lng:-117.9985026},
				{lat:34.1400471, lng:-118.036434},
				{lat:34.1318585, lng:-118.0496321},
				{lat:34.1326279, lng:-118.0495987},
				{lat:34.1341047, lng:-118.0485032},
	...
	var data = [
		...
		},
		{
			...
			routes: [
				...
				{duration: 15.8, pathId:13},
			]
		},
		{
			time: '08:26 AM',
			routes: [
				{duration: 15.3, pathId:12},
				{duration: 15.4, pathId:7},
				{duration: 15.0, pathId:13},
			]
		},
		{
			time: '08:28 AM',
