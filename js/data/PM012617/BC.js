...
function getObj() {
	var paths = [
		...
		{
			desc: 'E Colorado Blvd/Historic Rte 66 E',
			len: 9984,
			pts: [
				{lat:34.1380738, lng:-118.1249651},
				{lat:34.1389503, lng:-118.1228479},
		...
		{
			desc: 'San Pasqual St, E California Blvd and Huntington Dr',
			len: 8544,
			pts: [
				{lat:34.1380738, lng:-118.1249651},
				{lat:34.1389503, lng:-118.1228479},
		...
		},
		{
			...
			pts: [
				...
				{lat:34.1358006, lng:-118.0882678},
				{lat:34.133674, lng:-118.0882214},
				{lat:34.1336842, lng:-118.0860172},
				{lat:34.1314208, lng:-118.0859833},
				{lat:34.1289632, lng:-118.0846818},
				{lat:34.1316174, lng:-118.0502376},
				{lat:34.1318585, lng:-118.0496321},
				{lat:34.1326279, lng:-118.0495987},
				{lat:34.1341047, lng:-118.0485032},
		...
		},
		{
			...
			pts: [
				...
				{lat:34.1289722, lng:-118.0547327},
		...
		},
		{
			...
			pts: [
				...
				{lat:34.1421126, lng:-118.0986996},
				{lat:34.141627, lng:-118.0987062},
				{lat:34.1401774, lng:-118.0987173},
				{lat:34.1402073, lng:-118.094636},
				{lat:34.1357437, lng:-118.0943582},
				{lat:34.1346497, lng:-118.0733337},
				{lat:34.1305026, lng:-118.0732738},
				{lat:34.1316174, lng:-118.0502376},
	...
	var data = [
		...
		},
		{
			...
			routes: [
				...
				{duration: 20.1, pathId:18},
				{duration: 21.9, pathId:19},
			]
		},
		{
			time: '04:40 PM',
			routes: [
				...
				{duration: 20.0, pathId:20},
				{duration: 20.7, pathId:21},
			]
		},
		{
			time: '04:42 PM',
			routes: [
				...
				{duration: 20.3, pathId:22},
				{duration: 20.8, pathId:21},
			]
		},
		{
			time: '04:44 PM',
			routes: [
				...
				{duration: 21.7, pathId:17},
			]
		},
		{
			time: '04:46 PM',
			routes: [
				{duration: 21.0, pathId:13},
		...
		},
		{
			time: '04:52 PM',
			routes: [
				{duration: 21.3, pathId:13},
				{duration: 20.5, pathId:9},
			]
		},
		{
			time: '04:54 PM',
		...
		},
		{
			...
			routes: [
				...
				{duration: 22.8, pathId:23},
			]
		},
		{
			time: '04:58 PM',
			routes: [
				{duration: 21.9, pathId:24},
				{duration: 22.3, pathId:23},
				{duration: 23.9, pathId:13},
			]
		},
		{
			time: '05:00 PM',
			routes: [
				{duration: 21.6, pathId:16},
		...
		},
		{
			...
			routes: [
				...
				{duration: 22.3, pathId:29},
			]
		},
		{
			time: '05:20 PM',
			routes: [
				{duration: 21.5, pathId:12},
				{duration: 23.3, pathId:19},
			]
		},
		{
			time: '05:22 PM',
			routes: [
				...
				{duration: 23.5, pathId:30},
			]
		},
		{
			time: '05:24 PM',
			routes: [
				{duration: 21.6, pathId:4},
				{duration: 23.1, pathId:29},
			]
		},
		{
			time: '05:26 PM',
			routes: [
				...
				{duration: 21.3, pathId:17},
			]
		},
		{
			time: '05:28 PM',
			routes: [
				{duration: 22.2, pathId:31},
				{duration: 21.9, pathId:12},
				{duration: 23.7, pathId:15},
			]
		},
		{
			time: '05:30 PM',
			routes: [
				{duration: 22.5, pathId:12},
				{duration: 23.9, pathId:15},
			]
		},
		{
			time: '05:32 PM',
			routes: [
				...
				{duration: 22.1, pathId:10},
				{duration: 23.5, pathId:15},
			]
		},
		{
			time: '05:34 PM',
			routes: [
				{duration: 23.0, pathId:13},
		...
		},
		{
			time: '05:42 PM',
			routes: [
				{duration: 23.2, pathId:15},
				{duration: 23.6, pathId:33},
			]
		},
		{
			time: '05:44 PM',
			routes: [
				{duration: 22.8, pathId:10},
		...
		},
		{
			...
			routes: [
				...
				{duration: 21.1, pathId: 27},
				{duration: 21.6, pathId: 28},
				{duration: 22.7, pathId: 29},
				{duration: 23.5, pathId: 30},
				{duration: 22.2, pathId: 31},
				{duration: 24.3, pathId: 32},
				{duration: 23.6, pathId: 33},
				{duration: 22.0, pathId: 34},
				{duration: 20.2, pathId: 35},
			]
		}
	];
